      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          if (prev_size < 2) {
              ...
              // use two points to the path tangent to the car
          ...
          // In Frenet add evenly 30m spaced points from the start ref
          ...
          // Calculate the space of the lines, to get the desired velocity
          double target_x = 30.0;
          double target_y = s(target_x);
          double target_dist =
              sqrt((target_x) * (target_x) + (target_y) * (target_y));

          double x_add_on = 0;  // Start point
